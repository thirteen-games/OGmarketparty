...
//   hard   13/10/11/23  — the R6 gate at 400 crushes rigid savers (14%
//                         survival), the middle gates grind spenders, and
//                         the 1600 finish still cuts ~28% of gate-aware
//                         runs that earn R12. Every gate stays live for
//                         every style. (R9/R12 at 800/1200 simmed
//                         11/8/9/19; a 1800 finish inverted the mode —
//                         savers alive at R12 finished 100% while
//                         gate-aware died at the door.)
export const ROGUE_DIFFICULTIES = {
  ...
  hard: {
    label: 'Hard',
    emoji: '💀',
    targets: { 3: 60, 6: 400, 9: 750, 12: 1150, 15: 1600 },
...
export const TICKETS = [
  ...
  { id: 302, mascotId: 3, rarity: 'Common',    difficulty: 'Very Easy', cost: 2,  reward: 22,  target1: 2,  target2: null },
  ...
  { id: 405, mascotId: 4, rarity: 'Epic',      difficulty: 'Very Easy', cost: 5,  reward: 89,  target1: 8,  target2: -6 },
  ...
  { id: 505, mascotId: 5, rarity: 'Epic',      difficulty: 'Easy',      cost: 5,  reward: 114, target1: 11, target2: -10 },
  { id: 510, mascotId: 5, rarity: 'Legendary', difficulty: 'Hard',      cost: 10, reward: 229, target1: 9,  target2: -9 },
  // Joey's tickets: parity-priced on the ratio curve from his die's 4-roll
  // odds (balance-sim pipeline).
  { id: 601, mascotId: 6, rarity: 'Common',    difficulty: 'Easy',      cost: 1,  reward: 11,  target1: -1, target2: null },
  { id: 602, mascotId: 6, rarity: 'Common',    difficulty: 'Easy',      cost: 2,  reward: 26,  target1: 1,  target2: null },
  { id: 603, mascotId: 6, rarity: 'Rare',      difficulty: 'Easy',      cost: 3,  reward: 43,  target1: -3, target2: null },
  { id: 604, mascotId: 6, rarity: 'Super Rare', difficulty: 'Easy',      cost: 4,  reward: 73,  target1: 4,  target2: null },
  { id: 605, mascotId: 6, rarity: 'Epic',      difficulty: 'Very Easy', cost: 5,  reward: 93,  target1: 9,  target2: -6 },
  { id: 610, mascotId: 6, rarity: 'Legendary', difficulty: 'Hard',      cost: 10, reward: 211, target1: 7,  target2: -7 },
  { id: 110, mascotId: 1, rarity: 'Legendary', difficulty: 'Hard',      cost: 10, reward: 185, target1: 3,  target2: -3 },
  { id: 210, mascotId: 2, rarity: 'Legendary', difficulty: 'Hard',      cost: 10, reward: 247, target1: 11, target2: -9 },
  { id: 310, mascotId: 3, rarity: 'Legendary', difficulty: 'Hard',      cost: 10, reward: 184, target1: 3,  target2: -1 },
  { id: 410, mascotId: 4, rarity: 'Legendary', difficulty: 'Hard',      cost: 10, reward: 199, target1: 7,  target2: -5 },
];
...
const SPELL_COSTS = {
  ...
  154: 40, 254: 40, 354: 40, 454: 40, 554: 40, 654: 40,
  ...
  155: 20, 255: 20, 355: 5,  455: 20, 555: 25, 655: 25,
  156: 20, 256: 25, 356: 25, 456: 25, 556: 20, 656: 20,
  157: 25, 257: 25, 357: 25, 457: 25, 557: 25, 657: 25,
};
